...
fun NormalOpenAPIRoute.budget() {
    route("/budget") {
        route("/add").post<Unit, BudgetCreateRecordResponse, BudgetCreateRecordRequest>(info("Добавить запись")) { param, body ->
...
data class BudgetCreateRecordRequest(
...
data class BudgetCreateRecordResponse(
    @Min(1900) val year: Int,
    @Min(1) @Max(12) val month: Int,
    @Min(1) val amount: Int,
    val type: BudgetType,
...
data class BudgetYearParam(
    ...
    @QueryParam("ФИО") val fio: String? = null,
)
